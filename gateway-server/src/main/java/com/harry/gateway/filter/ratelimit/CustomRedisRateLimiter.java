...
public class CustomRedisRateLimiter extends RedisRateLimiter {
    ...
    public CustomRedisRateLimiter(org.springframework.data.redis.core.ReactiveRedisTemplate<String, String> redisTemplate, org.springframework.data.redis.core.script.RedisScript<List<Long>> script, Validator validator) {
     ...
     * @return
     */
    private Mono<Response> isSingleAllow(String key, String routeId, Config apiConf) {
        // How many requests per second do you want a user to be allowed to do?
        int replenishRate = apiConf.getReplenishRate();

        // How much bursting do you want to allow?
        int burstCapacity = apiConf.getBurstCapacity();
